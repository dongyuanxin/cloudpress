...
import { ConfigProvider, DatePicker, message, Checkbox, Row, Col, Switch, Pagination } from 'antd';
...
const ArchievePage = () => {
    ...
    const renderPassage = (passage) => {
        ...
        return <Row justify="space-between" gutter={24} className={styles['psg']}>
            <Col span={16} style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                <div className={styles['psg-icon']}>{index}</div>
                <div className={styles['psg-title']}>
                    <h2>{title}</h2>
                    <p>{description}</p>
                </div>
            </Col>
            ...
            <Col span={8} style={{display: 'flex', alignItems: 'center', justifyContent: 'flex-end'}}>
                <span className={styles['psg-info']}>
    ...
    return (
        <>
            <div className={styles.container}>
                <div className={styles['container-head-left']}>
                    <span>
                        全部文章
                    </span>
                    <span>
            ...
            <div className={styles['psg-pagination']}>
                {renderPagination()}
            </div>
        </>
    )
